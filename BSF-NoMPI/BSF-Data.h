...
// ========================= Lists ========================
static BT_extendedReduceElem_T		BD_extendedReduceList[PP_BSF_REDUCE_LIST_LENGTH];		// To be defined in Problem-bsfParameters.h
static BT_extendedReduceElem_T_1	BD_extendedReduceList_1[PP_BSF_REDUCE_LIST_1_LENGTH];	// To be defined in Problem-bsfParameters.h
static BT_extendedReduceElem_T_2	BD_extendedReduceList_2[PP_BSF_REDUCE_LIST_2_LENGTH];	// To be defined in Problem-bsfParameters.h
static BT_extendedReduceElem_T_3	BD_extendedReduceList_3[PP_BSF_REDUCE_LIST_3_LENGTH];	// To be defined in Problem-bsfParameters.h
...
static PT_bsf_mapElem_T				BD_mapList[PP_BSF_MAP_LIST_LENGTH];	// To be defined in Problem-bsfParameters.h
